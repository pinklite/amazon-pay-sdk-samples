<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="SampleCartDemo.RecurringPayments.index" %>
...
<body>
    <form id="recurringpayments" runat="server">
        <div>
            <div class="container">
                ...
                <div class="jumbotron jumbotroncolor" style="padding-top: 25px;" id="api_content">
